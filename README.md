...
| `syskit_nginx_sites` | _default_ `[]` | List of dict {'state': present/absent, 'enabled': yes/no, 'servers', 'upstreams'}. A _server_ is a dict {'name', 'port', ['default'], 'tls': [{'crtpath', 'keyval'}], 'locations'} An _upstream_ is a dict {'name', 'servers'}. An _upstream.server_ is a dict {'address', 'port', ['weight'], ['max_fails'], ['fail_timeout'], ['backup'], ['down'], ['max_conns'], ['resolve'], ['route'], ['slow_start']}. A _server.location_ is a dict {['uri'=/], ('root', ['autoindex'=off], ['expires']), ('proxy_pass')}.
 |
