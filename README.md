...
| `syskit_nginx_sites` | _default_ `[]` | List of dict {'state': present/absent, 'enabled': yes/no, 'upstream': {'name', 'address', 'port', 'timeout', 'protocol'}, 'server': {'name', ['port'], 'tls': [{'crtpath', 'keyval'}] } |
